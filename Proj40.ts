...
Objects are storing the album information correctly. Add 
an optional parameter to make_album() that allows you to 
store the number of tracks on an album. If the calling 
line includes a value for the number of tracks, add that 
value to the album’s Object. Make at least one new function 
...
let album1 = make_album('John Mayer', 'Born and Raised', 10);
console.log(album1);

let album2 = make_album('Pink Floyd', 'The Wall');
console.log(album2);

let album3 = make_album('The Beatles', 'Sgt. Pepper\'s Lonely Hearts Club Band', 12);
console.log(album3);
